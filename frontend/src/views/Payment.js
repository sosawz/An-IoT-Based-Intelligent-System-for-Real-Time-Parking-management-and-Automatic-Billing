    ...
    return (
        <section>
            <div className="container">
                ...
                {showReceipt && <Receipt entryTime={entryTime} exitTime={exitTime} plateNumber={plateNumber} customerName={customerName} serviceCharge={serviceCharge} handleDownload={handleDownload} handleShare={handleShare} />}
            </div>
        </section>
    );
}
